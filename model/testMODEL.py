...
###########################################
# Онлайн-тестирование модели на потоковых данных
###########################################

if __name__ == "__main__":
    data_root = "/Users/taniyashuba/PycharmProjects/eeg-transformer-gnn/data/preproc_clips_no_filter"
    model_path = "/Users/taniyashuba/PycharmProjects/eeg-transformer-gnn/model/eegnet2d_model_final.pth"  # Путь к сохранённой модели
    ...
    for i in range(len(dataset)):
        ...
        # Так как модель возвращает вероятность, применяем порог 0.5 для бинарной классификации
    ...
    # Вычисляем и выводим confusion matrix и отчёт по классификации

...
###########################################
# Улучшенная модель DSTGAT_Attn с residual connections и SE-блоком
###########################################
...
class Improved_DSTGAT_Attn(nn.Module):
    ...
    def forward(self, x, edge_index):
        ...
        branch_features = []
        # Многошкальная временная свёртка с attention
        ...
        x = self.gat1_bn(x)
        # Проекция исходных признаков для суммирования

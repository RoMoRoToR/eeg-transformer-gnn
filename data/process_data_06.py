...
def main():
    ...
    parser.add_argument("--bids_root", type=str, default="/Users/taniyashuba/PycharmProjects/eeg-transformer-gnn/data/ds004504",
                        help="BIDS root directory")
    parser.add_argument("--participants_tsv", type=str, default="participants.tsv",
                        help="Participants TSV file")
    parser.add_argument("--output_dir", type=str, default="preproc_clips",
